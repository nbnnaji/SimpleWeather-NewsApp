...
class MainActivity : AppCompatActivity() {
    ...
    private fun fetchCurrentWeatherData() {
        viewModel.fetchWeatherData("20c47b24499eeaddb308a27c29e9f57a", "Omaha,Nebraska")
    }
    ...
    private fun fetchTopHeadlineNewsData(){
        viewModel.fetchTopHeadLineNews(accessKey = "10e7c9954ca940d88a65fca6578c0e77", query = "weather")
    }
